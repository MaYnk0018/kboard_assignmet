  ...
  const setNewState = async(destinationDroppableId, task) => {
    ...
    switch (destinationDroppableId) {
      case "1":   // Pending
        ...
        let pendingResult = await AxiosService.put(`${ApiRoutes.TASK.path}/${updatedTask.taskId}`, {taskStatus: 'Pending'},{ headers : { 'Authorization' : `${getLoginToken}` } })
      ...
      case "2":  // OnGoing
        ...
        let workingResult = await AxiosService.put(`${ApiRoutes.TASK.path}/${updatedTask.taskId}`, {taskStatus: 'Ongoing'},{ headers : { 'Authorization' : `${getLoginToken}` } })
      ...
      case "3":  // Completed
        ...
        let completedResult = await AxiosService.put(`${ApiRoutes.TASK.path}/${updatedTask.taskId}`, {taskStatus: 'Completed'},{ headers : { 'Authorization' : `${getLoginToken}` } })
